...
public class UserController {
    ...
    public ResponseEntity<UserResponse> registerUser(@RequestBody SignupRequest userRequest){
        try {
            if (userRequest == null) {
...
//    }...
    ...
    @PutMapping("/edit")
    public ResponseEntity<UserResponse> updateUser(@RequestBody SignupRequest userRequest, Long id){
        try {

...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserResponse loginUser(SignupRequest userRequest) {

        UserResponse userResponse = userDao.findByEmail(userRequest.getEmail());


        if (userResponse != null && userResponse.getPassword()==userResponse.getPassword()) {
            return userResponse;
        }
    ...
    @Override
    public UserResponse updateUser(SignupRequest userRequest, Long id){
